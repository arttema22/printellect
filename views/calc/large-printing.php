    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="price">
            <table class="table table-bordered table-striped table-hover">
                <tbody>
                    <tr>
                        <th class="col-left"><span>Материал</span></th>
                        <th><span>dpi</span></th>
                        <th><span>До 1 м.п.</span></th>
                        <th><span>До 10 м.п.</span></th>
                        <th><span>От 10 м.п.</span></th>
                        <th><span>От 30 м.п.</span></th>
                    </tr>
                    <?php foreach ($lprinting as $uprice) { ?>
                        <tr>
                            <th><?= $uprice['material']; ?></th>
                            <th><?= $uprice['dpi']; ?></th>
                            <td><?= $uprice['up_meter_1']; ?> р.</td>
                            <td><?= $uprice['up_meter_10']; ?> р.</td>
                            <td><?= $uprice['from_meter_10']; ?> р.</td>
                            <td><?= $uprice['from_meter_30']; ?> р.</td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
